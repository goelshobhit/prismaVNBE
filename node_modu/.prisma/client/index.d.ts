...
export namespace Prisma {
  ...
  */
  ...
  export class Prisma__UserClient<T, Null = never, ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> implements Prisma.PrismaPromise<T> {
    ...
    movies<T extends User$moviesArgs<ExtArgs> = {}>(args?: Subset<T, User$moviesArgs<ExtArgs>>): Prisma.PrismaPromise<$Types.GetResult<MoviePayload<ExtArgs>, T, 'findMany', never>| Null>;
  ...
  export type MovieCreateManyUserInputEnvelope = {
    data: Enumerable<MovieCreateManyUserInput>
    skipDuplicates?: boolean
  }
